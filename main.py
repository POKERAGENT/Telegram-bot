...
async def start(msg: types.Message):
    ...
    text = f"<b>👋 Привет, {msg.from_user.first_name}!</b>\n\n<b>Добро пожаловать! \n\n<b>Зарегестрируйтесь в NUTS POKER и мы утроим ваш депозит!\n\n<b>С подробными условиями акции вы можете ознакомиться на сайте в разделе АКЦИИ, или в сообществе!</b>\n\nВыберите интересующий вас пункт:"
